...
class CartService {
    ...
    static async addToCart(userId, productId, quantity) {
        ...
        if (!cart) {
            ...
            const productIndex = cart.cart_products.findIndex((item) => item.productId?.toString() === productId.toString());
            if (productIndex > -1) {
    ...
    static async removeFromCart(userId, productId) {
        ...
        cart.cart_products = cart.cart_products.filter((item) => item.productId?.toString() !== productId.toString());
