...
const Notification: React.FC = () => {
    ...
    return (
        <div
            ...
            {/* <div className="absolute text-[13px] px-[5px]  rounded-[50%] bottom-1 left-2 h-fit bg-[#A769FD]">{unreadNotification?.length}</div> */}
                                ...
                                notifications?.map((n) => (
                                    <Link
                                        ...
                                        <div className="w-ful text-base">
                                            <h3 className="font-normal text-black truncate-trailing line-clamp-1  ">{n?.title}</h3>
                                            <div className="flex gap-1 items-center">
                                                <span className="text-sm text-primary font-semibold shrink-0">{n.user_name}</span>
