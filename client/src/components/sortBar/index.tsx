        ...
        <>
            ...
            {(star || pricefrom || priceto || brand) && (
                <div className="flex gap-3">
                    {star && <ButtonOutline className="rounded-full text-sm py-1 px-4 font-normal bg-blue-50">Từ {star} sao</ButtonOutline>}
                    {pricefrom && (
                    ...
                    {Array.isArray(brand)
                        ? brand?.map((b) => <ButtonOutline className="rounded-full text-sm py-1 px-4 font-normal bg-blue-50">{b}</ButtonOutline>)
                        : brand && <ButtonOutline className="rounded-full text-sm py-1 px-4 font-normal bg-blue-50">{brand}</ButtonOutline>}
                    <ButtonOutline
