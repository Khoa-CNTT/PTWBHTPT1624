                        ...
                        return (
                            <div
                                ...
                                className={`flex justify-between items-center p-4 border border-gray-200 rounded-md hover:shadow-md transition ${
                                    !isVoucherValid ? 'opacity-50 cursor-not-allowed' : ''
                                }`}>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <label className="relative flex items-center">
                                        <input
                                            ...
                                            onChange={() => isVoucherValid && handleSelectVoucher(voucher)}
                                            disabled={!isVoucherValid}
                                            className={`appearance-none w-6 h-6 border-2 border-gray-300 rounded-full focus:outline-none ${
                                                isVoucherValid ? 'checked:border-red-500 checked:bg-red-500' : 'cursor-not-allowed'
                                            }`}
                                        />
