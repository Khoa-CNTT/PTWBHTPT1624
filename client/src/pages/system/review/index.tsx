...
export default function ReviewManage() {
    ...
    const handleApprove = async (id: string) => {
        ...
        const notification: INotification = {
            ...
            notification_link: `/${res?.review.review_product_slug}/${res?.review.review_productId}`,
        };
        const response = await sendNotificationToUser(res?.review.review_user, notification);
        socket.emit('sendNotificationToUser', {
            ...response.data,
            userId: res?.review.review_user,
        });
    };
